...
# Semantic section icons used by ravn-cli.
# shellcheck disable=SC2034 # Public constants used by ravn-cli after source.
readonly \
  ICON_KEY="󰌋" \
  ICON_LOCK="" \
  ICON_GIT="" \
...
# shellcheck disable=SC2034 # Public icon catalog used by ravn-cli after source.
